...
| | Prompt-Based | JSON Mode | Function Calling (Tool Use) |
|---|---|---|---|
| Reliability | ~ | ++ | +++ |
| Flexibility | +++ | ++ | + |
| Validation | --- | + | +++ |
| Use when | Simple extracts, flexible schemas, quick prototypes | Need valid JSON, moderate complexity, Claude/GPT models | Strict schemas required, tool orchestration, type-safe parsing |

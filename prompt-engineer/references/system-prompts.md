...
A well-structured system prompt has five sections, in order:

1. **Identity & Role** — Who is the AI? What expertise does it have?
2. **Capabilities & Constraints** — What can/can't the AI do? What are the boundaries?
3. **Behavioral Guidelines** — How should it respond? Tone, format, approach?
4. **Context & Knowledge** — What information does it have access to?

...
description: Reference on wording documents agents consume by pointer — AGENTS.md/CLAUDE.md phrasing, pointer wording, and context-load budgeting. Use when editing AGENTS.md or CLAUDE.md, or as a companion reference while writing-skills/skill-creator drives skill creation.
---
